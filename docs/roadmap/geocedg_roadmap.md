...
| Siguiente puerta | `PRE-G9B-S2 — DESIGNED / NOT YET IMPLEMENTATION-AUTHORIZED`; S3, S4, D1, P1, G9B, G9C, G9U2, más G12 y G10 productivo permanecen no autorizados |
...
`PASS — AUTHOR APPROVED`. S2–S4, remediación de
