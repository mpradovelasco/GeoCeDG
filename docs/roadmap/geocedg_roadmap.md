...
| Siguiente puerta | `PRE-G9B-P1` puede comenzar solo mediante su autorización separada para superficie pública y package/distribution state; ni D1 ni P0 lo inician ni lo autorizan. Contactos COMMERCIAL-A/OpenGeoProver, distribución comercial, marca figurativa, G9B, G9C, G9U2, G12 y G10 productivo permanecen no autorizados |
...
**PASS** y `selfApproved=false`. P1 y la promoción pública no están autorizadas.
