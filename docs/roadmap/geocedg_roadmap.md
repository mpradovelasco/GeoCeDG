...
| Siguiente puerta | disposición autoral sobre la evidencia semántica que falta para el `m` periódico antes de producir un candidato S1 corregido; la política de población completa queda `DESIGN / AUTHOR DISPOSITION REQUIRED` y se propone `PRE-G9B-S1-COMPLETE-POPULATION` sin autorización; S1-SPLINE-DXF no resulta necesario; S2–S4, D1, P1, G9B, G9C, G9U2, más G12 y G10 productivo permanecen no autorizados |
