...
**Status: G8C1 rows author-approved normative scope; G8C2 rows proposed;
...
implementation scope; it is authorized but not yet implemented. G8C2 rows
remain proposed and not authorized.
